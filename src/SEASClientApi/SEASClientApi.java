package SEASClientApi;

/*
 * IBM and Sterling Commerce Confidential
 * OCO Source Materials
 * IBM Sterling  External Authentication Server
 * © Copyright Sterling Commerce, an IBM Company  2003, 2011
...
/**
javac -cp hadrian-client.jar;componentCommon.jar -sourcepath src -d ..\build *.java
*/

/**
 * Class to make a client connection to SEAS
 * 
 * @author iikonne
 * 
 */
public class SEASClientApi {
	 ...
	 * @param serverPort
	 */
	public SEASClientApi(String serverHost, int serverPort) {
	 ...
	 * @param sslInfo
	 */
	public SEASClientApi(String serverHost, int serverPort, SslInfo si) {
		params = new ConnectParams();
		params.setHost(serverHost);
		params.setPort(serverPort);
 ...
 */
	 ...
	 */
	public SEASClientApi(Properties props) {
		this.initialize(props);
	}
	...
	static public void main(String[] args) {
		...
		SEASClientApi sai = null;
		try {
			sai = new SEASClientApi();
			sai.connect();

			//authenticate and generate token
			String token = sai.requestSSOToken("iikonne", "Password01", "authProfile");
			System.out.println("Token : " + token);
			boolean validated = sai.validateSSOToken("iikonne", token, false);
